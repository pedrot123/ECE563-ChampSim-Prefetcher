 # ECE563-ChampSim-Prefetcher
  ...
  To run:
  - `make clean`
  - `./build_champsim.sh bimodal no no adaptive_stride_nline no lru 1`
  - `./bin/bimodal-no-no-adaptive_stride_nline-no-lru-1core -warmup_instructions 10000000 -simulation_instructions 50000000 -traces traces/600.perlbench_s-210B.champsimtrace.xz`

  `600.perlbench_s-210B.champsimtrace.xz` is from the [3rd Data Prefetching Championship](https://dpc3.compas.cs.stonybrook.edu/champsim-traces/speccpu/)
